...
/makechar name race [hp acc eva atk dfn spd ran]: Create a character with the given name, race, and stat point distribution.
    Accepted races: crate, faerie, elf, human, werecat, elfcat, cyborg, robot, kraken, elfship, steamship
/restat name hp acc eva atk dfn spd ran: Reshuffle your stats. Only works outside of battle.
